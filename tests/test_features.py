...
def test_age_bins():
    ...
    assert df["age_bin"].iloc[0] == 0
    assert df["age_bin"].iloc[1] == 1
...
def test_add_all_basic_features():
    ...
    for col in ["sleep_efficiency", "sleep_debt", "caffeine_screen_interaction",
